...
<div
    {{ $attributes->merge([
        'class' =>
            'flex flex-col items-center justify-center px-6 py-12 text-center border border-dashed border-slate-300 rounded-2xl bg-slate-50',
    ]) }}>
    <div class="flex items-center justify-center w-12 h-12 bg-white border rounded-full shadow-sm border-slate-200">
